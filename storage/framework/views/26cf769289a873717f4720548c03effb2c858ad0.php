...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/png" href="<?php echo e(url('/images/favicon.png')); ?>" />
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" title="User menu"
                                ...
                                <figure class="avatar avatar-sm">
                                    <img src="/images/logo-header.png" class="rounded-circle" alt="avatar">
                                </figure>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                                <div class="text-center py-4"
                                    ...
                                    <figure class="avatar avatar-lg mb-3 border-0">
                                        <img src="/images/logo-header.png" class="rounded-circle" alt="image">
                                    </figure>
                                    <h5 class="mb-0"><?php echo e(auth()->user()->name); ?></h5>
                                </div>
                                <div class="list-group list-group-flush">

                                    <a href="/adminlogout" class="list-group-item text-danger">Sign Out!</a>
                                </div>
                            </div>
                        </li>
                    </ul>
        ...
        <div class="content-wrapper">
            ...
            <div class="navigation">
                ...
                <div class="navigation-header">
                    <a class="navigation-logo" href="/admin/index">
                ...
                <div class="navigation-menu-wrapper">
                    ...
                    <div class="navigation-menu-body">
                        <ul id="pages">
                            ...
                            <li>
                                <a class="<?php echo e(Request::segment(2) == 'index' ? 'active' : ''); ?>"
                                    href="/admin/index">
                            ...
                            <li>
                                <a class="<?php echo e(Request::segment(2) == 'eventlist' ? 'active' : ''); ?>"
                        ...
                        <ul id="packages">
                            ...
                            <li>
                                <a class="<?php echo e(Request::segment(2) == 'category' ? 'active' : ''); ?> <?php echo e(Request::segment(2) == 'edit-packege' ? 'active' : ''); ?>"
                                    href="/admin/category">
                                    <span class="nav-link-icon" data-feather="plus"></span>
                            ...
                            <li>
                                <a class="<?php echo e(Request::segment(2) == 'categorylist' ? 'active' : ''); ?>"
                        ...
                        <ul id="users">
                            ...
                            <li>
                                <a class="<?php echo e(Request::segment(2) == 'users-usg' ? 'active' : ''); ?>"
                            ...
                            <li>
                                <a class="<?php echo e(Request::segment(2) == 'users-list' ? 'active' : ''); ?>"
                        ...
                        <ul id="reports">
                            ...
                            <li>
                                <a class="<?php echo e(Request::segment(2) == 'reports' ? 'active' : ''); ?>"
                            ...
                            <li>
                                <a class="<?php echo e(Request::segment(2) == 'reportslist' ? 'active' : ''); ?>"
            ...
            <div class="content-body">
                ...
                <footer class="content-footer">
                    <div><a href="https://manakal.com" target="_blank">© <?php echo e(date('Y')); ?> buttercupevents.com</a></div>
...
<?php /**PATH D:\sadeesh\eventmanager\resources\views/admin/includes/dashboard.blade.php ENDPATH**/ ?>