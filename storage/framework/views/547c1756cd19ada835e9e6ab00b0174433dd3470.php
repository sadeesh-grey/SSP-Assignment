                    ...
                    <div class="row">
                        ...
                        <div class="single-product-item col-lg-4 col-md-6 col-sm-12 text-center">
                            <div class="img-holder">
                                <a href="/eventlist/<?php echo e($event->id); ?>"><img width="270" height="300" src="images/resource/products/1.jpg" class="" alt=""></a>
                            </div>
                            <div class="title-holder text-center">
                                <div class="static-content">
                                    <h3 class="title text-center"><a href="/event"><?php echo e($event->event_name); ?></a></h3>
                                    <h3 class="title text-center"><a href="/event">   </a></h3>
                                    <h3 class="title text-center"><a href="/event"><?php echo e($event->category); ?></a></h3>
                                    <h3 class="title text-center"><a href="/event">Event count <?php echo e($event->event_count); ?></a></h3>
                                    <span class="price"><span class="amount"><span class="">LKR</span><?php echo e($event->price); ?></span></span>
                                </div>
...
<?php echo $__env->make('web.includes.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\sadeesh\eventmanager\resources\views/web/allevent.blade.php ENDPATH**/ ?>