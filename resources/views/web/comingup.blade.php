                        ...
                        <div class="single-product-item col-lg-4 col-md-6 col-sm-12 text-center">
                            ...
                            <div class="title-holder text-center">
                                <div class="static-content">
                                    <h3 class="title text-center"><a href="shop-detail.html">{{ $comingup->event_name }}</a></h3>
                                    <h3 class="title text-center"><a href="shop-detail.html">   </a></h3>
                                    <h3 class="title text-center"><a href="shop-detail.html">{{ $comingup->category }}</a></h3>
                                    <span class="price"><span class="amount"><span class="">LKR</span>{{ $comingup->price }}</span></span>
                                </div>
