        ...
        <div class="content-wrapper">
                ...
                <div class="navigation-menu-wrapper">
                    ...
                    <div class="navigation-menu-body">
                        <ul id="pages">
                            ...
                            {{-- <li>
                                <a class="{{ Request::segment(2) == '' ? 'active' : '' }}" href="/admin/index/">
                                    <span class="nav-link-icon" data-feather="info"></span>
                                    <span>Account Info</span>
                                </a>
                            </li> --}}
                            <li>
                                <a class="{{ Request::segment(2) == 'index' ? 'active' : '' }}"
                                    href="/admin/index">
                            ...
                            <li>
                                <a class="{{ Request::segment(2) == 'eventlist' ? 'active' : '' }}"
                        ...
                        <ul id="packages">
                            ...
                            <li>
                                <a class="{{ Request::segment(2) == 'category' ? 'active' : '' }} {{ Request::segment(2) == 'edit-packege' ? 'active' : '' }}"
                                    href="/admin/category">
                                    <span class="nav-link-icon" data-feather="plus"></span>
                            ...
                            <li>
                                <a class="{{ Request::segment(2) == 'categorylist' ? 'active' : '' }}"
            ...
            <div class="content-body">
                ...
                <footer class="content-footer">
                    <div><a href="https://manakal.com" target="_blank">© {{ date('Y') }} buttercupevents.com</a></div>
